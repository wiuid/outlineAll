...
import tableScripts from "./tableScripts/tableScripts";
import tableCollaboration from "./tableCollaboration";
...
router.use("/", tableCollaboration.routes());
...
router.use("/", tableScripts.routes());
